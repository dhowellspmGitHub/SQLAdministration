/****** Object:  Role [db_tobedeleted]    Script Date: 06/07/2013 12:51:35 ******/
USE [RUTest1]	--REPLACE THIS TEXT TO THE DATABASE NAME WHERE THE ROLE WILL BE CREATED--
GO

IF NOT EXISTS (SELECT * FROM sys.database_principals WHERE name = N'db_tobedeleted' AND type = 'R')
BEGIN
CREATE ROLE [db_tobedeleted] AUTHORIZATION [dbo]
END
GO
