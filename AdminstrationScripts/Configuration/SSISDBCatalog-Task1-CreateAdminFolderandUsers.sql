...
--compare the locations of the master database and the SSISDB. If the SSISDB is not in the same location as the master, then stop the Integration Services, detach the SSISDB database, move the files and then reattach the database.  THIS STEP IS NOT MANDATORY BUT SHOULD BE DONE IF THE SSISDB IS CREATED ON A RAW DEVICE CONTAINING OTHER USER DATABASES AND THOSE USER DATABASES HAVE AN APPSYNC JOB.  WE CANNOT HAVE THE SSISDB FILES ON A RAW LUN SHARED WITH ANOTHER DATABASE.
*/
--Check if SSISDB in SIMPLE mode and other properties
USE [master]
GO
IF EXISTS (SELECT * FROM sys.databases WHERE name like 'SSISDB' AND recovery_model = 1)
BEGIN
	ALTER DATABASE [SSISDB] SET RECOVERY SIMPLE WITH NO_WAIT
END


/* Set SSISDB properties for logging*/
EXEC [SSISDB].[catalog].[configure_catalog] @property_name=N'RETENTION_WINDOW', @property_value=30
EXEC [SSISDB].[catalog].[configure_catalog] @property_name=N'SERVER_CUSTOMIZED_LOGGING_LEVEL', @property_value=N''
...
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=13, @permission_type=1
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=13, @permission_type=2
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=13, @permission_type=4
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=13, @permission_type=100
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=13, @permission_type=102
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=13, @permission_type=103
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=13, @permission_type=101
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=13, @permission_type=104
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=14, @permission_type=1
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=14, @permission_type=2
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=14, @permission_type=4
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=14, @permission_type=100
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=14, @permission_type=102
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=14, @permission_type=103
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=14, @permission_type=101
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=14, @permission_type=104
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=15, @permission_type=1
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=15, @permission_type=2
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=15, @permission_type=4
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=15, @permission_type=100
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=15, @permission_type=102
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=15, @permission_type=103
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=15, @permission_type=101
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=15, @permission_type=104
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=16, @permission_type=1
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=16, @permission_type=2
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=16, @permission_type=100
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=16, @permission_type=102
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=16, @permission_type=103
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=16, @permission_type=101
EXEC [SSISDB].[catalog].[grant_permission] @object_type=1, @object_id=1, @principal_id=16, @permission_type=104
