...
***************************************************/
DECLARE @currset BIGINT = 0
DECLARE @currtbl NVARCHAR(128)

SET @currtbl = 'internal.event_message_context'
SELECT (N'Deleting:' + @currtbl), COUNT(*)
...
SET @currtbl = 'internal.executable_statistics'
SELECT (N'Deleting:' + @currtbl), COUNT(*)
