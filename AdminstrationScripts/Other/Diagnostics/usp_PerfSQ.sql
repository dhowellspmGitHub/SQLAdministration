-----------------------------------------------------------------------------------------
-- Query performance metrics: https://www.sqlservercentral.com/articles/query-performance-diagnostics-with-usp_PerfSQ
-- Script downloaded from https://www.sqlservercentral.com/scripts/usp_PerfSQ
-- usp_PerfSQ: Query Shaping tool identifying Performance features of active SQL Queries
...
--    GO
-- 
--    EXEC dbo.usp_PerfSQ @ParamSniff=0.75, @SessionLocks=1
--    GO
-- 
-- Email: QueryShape@gmail.com
-- 
-----------------------------------------------------------------------------------------
CREATE PROCEDURE dbo.usp_PerfSQ @ParamSniff float = NULL, @SessionLocks bit = NULL
AS
BEGIN
SET NOCOUNT ON ;
...
SET @CmdLine      = N'EXEC usp_PerfSQ ' + N'@ParamSniff=' + CONVERT(nvarchar(20),@ParamSniff) + N', @SessionLocks=' + CONVERT(nvarchar(1),@SessionLocks) + N'  --v' + @Version ;
SET @Runtime      = getdate() ;
