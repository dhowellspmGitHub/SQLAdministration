/* 
An Example the procedure's execution script is listed first followed by the script to
create the Who_Is_Active stored procedure using the script below.
*/
USE [msdb]
GO
...
EXEC	@return_value = [dbo].[sp_WhoIsActive]
		...
		--@sort_order = NULL,
		--@format_output = NULL,
		--@destination_table = 'dhwhoisactive',
		--@return_schema = 1,
