...
/* All the below queries should have no (zero) records returned.  These queries confirm the DBP, DBRMs, DBR permissions and DBRs that were backed up/in the database before the restore exist after the restore
*/
