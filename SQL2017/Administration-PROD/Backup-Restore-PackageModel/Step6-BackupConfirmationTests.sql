USE [CC_W_ETL]
GO
/* In the below queries, left outer joins are used to compare the current database principals to those in the restore_* tables.
NULL Values in the LOJ table are acceptable ONLY for system generated entities.
Example: the DBO user should have a NULL value in the backed up users table because it is a system generated and managed account.
However, a standard, KFB created DBP must have a match in the LOJ
*/
...
WHERE [RDPM1].[member_principal_id] IS NULL
