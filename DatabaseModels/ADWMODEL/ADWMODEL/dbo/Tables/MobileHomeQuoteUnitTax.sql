CREATE TABLE [dbo].[MobileHomeQuoteUnitTax] (
    ...
    CONSTRAINT [PK_MobileHomeQuoteUnitTax] PRIMARY KEY CLUSTERED ([QuoteNbr] ASC, [UnitNbr] ASC) ON [POLICYCD],
    CONSTRAINT [FK_MobileHomeQuoteUnitTax_MobileHomeQuoteUnit_01] FOREIGN KEY ([QuoteNbr], [UnitNbr]) REFERENCES [dbo].[MobileHomeQuoteUnit] ([QuoteNbr], [UnitNbr])
) ON [POLICYCD];
