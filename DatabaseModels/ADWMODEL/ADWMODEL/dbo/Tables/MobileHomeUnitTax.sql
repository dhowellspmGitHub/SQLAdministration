CREATE TABLE [dbo].[MobileHomeUnitTax] (
    ...
    CONSTRAINT [PK_MobileHomeUnitTax] PRIMARY KEY CLUSTERED ([PolicyId] ASC, [UnitNbr] ASC) ON [POLICYCD],
    CONSTRAINT [FK_MobileHomeUnitTax_MobileHomeUnit_01] FOREIGN KEY ([PolicyId], [UnitNbr]) REFERENCES [dbo].[MobileHomeUnit] ([PolicyId], [UnitNbr])
) ON [POLICYCD];
