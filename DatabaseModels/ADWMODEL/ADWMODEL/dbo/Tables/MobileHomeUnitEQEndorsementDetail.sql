CREATE TABLE [dbo].[MobileHomeUnitEQEndorsementDetail] (
    ...
    CONSTRAINT [PK_MobileHomeUnitEQEndorsementDetail] PRIMARY KEY CLUSTERED ([PolicyId] ASC, [UnitNbr] ASC, [EndorsementId] ASC, [ItemNbr] ASC) ON [POLICYCD],
    CONSTRAINT [FK_MobileHomeUnitEQEndorsementDetail_MobileHomeUnitEndorsement_01] FOREIGN KEY ([EndorsementId], [PolicyId], [UnitNbr]) REFERENCES [dbo].[MobileHomeUnitEndorsement] ([EndorsementId], [PolicyId], [UnitNbr])
) ON [POLICYCD];
