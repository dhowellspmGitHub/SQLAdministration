CREATE TABLE [dbo].[AutoQuoteEndorsement] (
    ...
    CONSTRAINT [PK_AutoQuoteEndorsement] PRIMARY KEY CLUSTERED ([QuoteNbr] ASC, [EndorsementNbr] ASC) ON [POLICYCD],
    CONSTRAINT [FK_AutoQuoteEndorsement_AutoQuote_01] FOREIGN KEY ([QuoteNbr]) REFERENCES [dbo].[AutoQuote] ([QuoteNbr])
) ON [POLICYCD];
