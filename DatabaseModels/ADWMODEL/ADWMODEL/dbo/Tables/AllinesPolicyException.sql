CREATE TABLE [dbo].[AllinesPolicyException] (
    ...
    [BatchCycleDt]        DATE          NOT NULL,
    [UserUpdatedId]       CHAR (8)      NOT NULL,
    [LastActionCd]        CHAR (1)      NOT NULL,
    [SourceSystemCd]      CHAR (2)      NOT NULL,
    CONSTRAINT [PK_AllinesPolicyException] PRIMARY KEY CLUSTERED ([ExceptionId] ASC) ON [POLICYCD]
) ON [POLICYCD];
