CREATE TABLE [dbo].[FireUnit] (
    ...
    [NumberOfFamiliesCnt]         INT             NULL,
    [RatingTerritoryCd]           CHAR (2)        NULL,
    [UnitRateCd]                  CHAR (1)        NULL,
    [SubstandardConditionCd]      CHAR (1)        NULL,
    [PremiumCd]                   CHAR (1)        NULL,
    ...
    [AllinesOutBuildingNbr]       INT             NULL,
    [LighteningRodCreditInd]      CHAR (1)        NULL,
    [RateClassCd]                 CHAR (2)        NULL,
    [ExclusionTypeCd]             CHAR (1)        NULL,
    [ShedOrConditionInd]          CHAR (1)        NULL,
    [MineSubsidenceInd]           CHAR (1)        NULL,
    [AllinesPersonalPropertyNbr]  INT             NULL,
    [UnitTypeCd]                  CHAR (1)        NULL,
    [ExtraOutbuildingInd]         CHAR (1)        NULL,
    [UpdatedTmstmp]               DATETIME2 (7)   NOT NULL,
    [UserUpdatedId]               CHAR (8)        NOT NULL,
    [LastActionCd]                CHAR (1)        NOT NULL,
    [SourceSystemCd]              CHAR (2)        NOT NULL,
    CONSTRAINT [PK_FireUnit] PRIMARY KEY CLUSTERED ([PolicyId] ASC, [UnitNbr] ASC) ON [POLICYCD],
    CONSTRAINT [FK_FireUnit_FirePolicy_01] FOREIGN KEY ([PolicyId]) REFERENCES [dbo].[FirePolicy] ([PolicyId])
) ON [POLICYCD];


GO
CREATE NONCLUSTERED INDEX [IX_FireUnit_01]
    ON [dbo].[FireUnit]([PolicyId] ASC)
    ON [POLICYCI];
