CREATE TABLE [dbo].[QuoteAdditionalInsured] (
    [QuoteAdditionalInsuredId]  BIGINT        NOT NULL,
    ...
    CONSTRAINT [PK_QuoteAdditionalInsured] PRIMARY KEY CLUSTERED ([QuoteAdditionalInsuredId] ASC, [QuoteNbr] ASC) ON [POLICYCD],
    CONSTRAINT [FK_QuoteAdditionalInsured_Quote_01] FOREIGN KEY ([QuoteNbr]) REFERENCES [dbo].[Quote] ([QuoteNbr])
) ON [POLICYCD];
